<p align="center">
  ...
  <p align="center">SPAR Fall 2026 · <a href="https://github.com/alanasung/moral-shadowban">Do Models Quietly Downgrade Users They Judge Immoral</a></p>
</p>
...
**Do Models Quietly Downgrade Users They Judge Immoral**. The shared engineering spine (config, caching, hooks, metrics,
...
| Stage | Module | Output |
|---|---|---|
| Compose config | `configs/` + `moralban.configs` | resolved `config.yaml` |
| Build data | `moralban.data` | splits + manifest |
| Load model | `moralban.models` | `LoadedModel` + resolved commit |
| Run stages | `scripts/run_experiment.py` | per-stage JSON |
| Aggregate | `moralban.reporting` | `results.json` + tables + figures |
...
├── src/moralban/       # installable library (print-free)
...
- SPAR Fall 2026 project posting: https://github.com/alanasung/moral-shadowban
- Complexity bar: Critical Data PRIMED-AI / RecursiveJEPA engineering standard

## Citation

```bibtex
@misc{moralban_spar_f26,
  title        = {Do Models Quietly Downgrade Users They Judge Immoral},
  author       = {Alana Sung},
  year         = {2026},
  howpublished = {SPAR Fall 2026},
  note         = {Measure whether models degrade HHH quality when they infer a user has poor moral character.},
  url          = {https://github.com/alanasung/moral-shadowban}
}
```
...
Ablations live under `src/moralban/ablation/` and return structured dicts. Presets

...
This note situates **Do Models Quietly Downgrade Users They Judge Immoral** against the motivating literature for
[Do Models Quietly Downgrade Users They Judge Immoral](https://github.com/alanasung/moral-shadowban).

## Positioning

Measure whether models degrade HHH quality when they infer a user has poor moral character.

The design hypothesis is: Measure whether models degrade HHH quality when they infer a user has poor moral character.

"""Experiment stages for Do Models Quietly Downgrade Users They Judge Immoral."""
...
from .moralban._util import ensure_dir, stage_result, write_json
...
def stage_report(cfg: DictConfig, run_dir: Path) -> dict[str, Any]:
    ...
    write_json(
        out / "report.json",
        {"headline": "Do Models Quietly Downgrade Users They Judge Immoral", "claims_gated": True},
    )
